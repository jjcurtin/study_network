...
```{r}
err_tbl |>
  write_csv("_results/err_tbl_xgboost_v1.csv")

fits_lst |>
  write_rds(here::here(path_models, "fits_lst_xgboost_v1.rds"))

best_models |> 
  write_rds(here::here(path_models, "best_models_xgboost_v1.rds"))
```
