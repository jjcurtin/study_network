---
title: "XGBoost Models with Contact Network Features"
author: "Coco Yu"
...
# poisson model
update_results(run_xgboost(data = data, outcome = "continuous", 
...
update_results(run_xgboost(data = data, outcome = "binary_high_low", 
...
```{r}
err_tbl |> 
  write_csv("_results/err_tbl_v3.csv")

fits_lst |> 
  write_rds(here::here(path_models, "fits_lst_v3.rds"))

best_models |> 
  write_rds(here::here(path_models, "best_models_v3.rds"))
```
