---
title: "Analysis on XGBoost Models with Contact Network Features"
author: "Coco Yu"
...
```{r}
fits <- read_rds(here::here(path_models, "fits_lst_v3.rds"))
err_tbl <- read_csv("_results/err_tbl_v3.csv")
```
