...
```{r}
features_msgs_v1 <- read_csv(here::here(path_network, "features_network_v5.csv"))
features_msgs_v2 <- read_csv(here::here(path_network, "features_network_v6.csv")) 
...
features_lst_contact <- list(features_v1, features_v2, features_v3, features_v4)
```

```{r}
features <- list(features_msgs_v1, features_msgs_v2)
feature_versions <- c(
                   "features_msgs_v1", 
                   "features_msgs_v1_full",
                   "features_msgs_v2", 
                   "features_msgs_v2_full")
...
configs <- configs |> bind_rows(
  tibble(
    data_lst = rep(features_lst_contact, times = 2) |> 
      map2(rep(features, each = 4), \(feature, feature_msgs)
          feature |> 
            left_join(labels, by = "subid") |>
            left_join(feature_msgs, by = "subid") |> 
            mutate(lapse = as.integer(n_lapse / day_on_study * 91)) |>
            select(-n_lapse, -day_on_study, -subid)),
    feature_versions = c("features_msgs_v1_contact_v1", "features_msgs_v1_contact_v2",
                         "features_msgs_v1_contact_v3", "features_msgs_v1_contact_v4",
                         "features_msgs_v2_contact_v1", "features_msgs_v2_contact_v2",
                         "features_msgs_v2_contact_v3", "features_msgs_v2_contact_v4"),
    outcome_lst = "continuous"
  ) |> expand_grid(
    model_lst = c("poisson", "normal"),
    feature_lst = c("raw", "prop", "all")
    ...
    data_lst = rep(features_lst_contact, times = 2) |> 
      map2(rep(features, each = 4), \(feature, feature_msgs)
          feature |> 
            ...
            mutate(lapse = as.integer(n_lapse / day_on_study * 91)) |>
            select(-n_lapse, -day_on_study, -subid)),
    feature_versions = c("features_msgs_v1_contact_v1_full",
                         "features_msgs_v1_contact_v2_full",
                         "features_msgs_v1_contact_v3_full", 
                         "features_msgs_v1_contact_v4_full",
                         "features_msgs_v2_contact_v1_full",
                         "features_msgs_v2_contact_v2_full",
                         "features_msgs_v2_contact_v3_full", 
                         "features_msgs_v2_contact_v4_full"),
    outcome_lst = "continuous"
  ) |> expand_grid(
    model_lst = c("poisson", "normal"),
    feature_lst = c("raw", "prop", "all")
